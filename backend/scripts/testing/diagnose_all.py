...
try:
    ...
    try:
        ...
        if result.errors:
            ...
            query_types = [
                ...
                or t["name"] in ["EmergencyType", "ProviderType"]
            ]
    ...
    test_queries = [
        {"name": "Simple type query", "query": "{ __typename }"},
        {"name": "List emergencies", "query": "{ emergencies { id emergencyType } }"},
        {"name": "List providers", "query": "{ providers { id name } }"},
    ]
